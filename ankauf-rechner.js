...
(function () {
  ...
  function fallbackNachricht() {
    return "Hallo, ich möchte ein Gerät verkaufen, das nicht in Ihrer Liste steht: …";
  }
  ...
  function ladeKategorieDaten(kategorie) {
    ...
    return fetch("ankauf/" + kategorie + ".json")
      .then(function (res) {
  ...
  function renderMarken() {
    ...
    var chips = ['<button type="button" class="rechner-chip' + (state.marke === null ? " active" : "") + '" data-marke="">Alle Marken</button>'];
